...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "@tsdotnet/observable-base"], factory);
    }
     ...
     */
    class LegacyNodeWorker extends observable_base_1.ObservableBase {
        onmessage;
        onerror;
        _process;
        constructor(url) {
    ...
    exports.default = LegacyNodeWorker;
});
